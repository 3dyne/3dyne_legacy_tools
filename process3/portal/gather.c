...
#if 0
	printf( "classify brush surfaces ...\n" );
	if ( CheckCmdSwitch2( "--classify-all" ) )
	{
		ClassifyLeafsRecursive( HManagerGetRootClass( nodehm ), brushhm, false );
	}
	else
	{
		ClassifyLeafsRecursive( HManagerGetRootClass( nodehm ), brushhm, true );
	}
#endif
