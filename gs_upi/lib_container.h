...
void *		U_RingSearchObj( u_ring_t *ring, void *objptr );		// sets current
...
void *		U_MapRemove( u_map_t *map, void *key );		// return NULL if no object with the key could be removed
void *		U_MapSearch( u_map_t *map, void *key );		// return NULL if no object with the key was found
